...
## Expected use
Synthetic weekly engagement records are included. No OULAD adapter is bundled. A future adapter should map activity features with their time semantics documented explicitly.
